defmodule TestElixirAuthWeb.UserResetPasswordControllerTest do
  ...
  describe "POST /api/users/reset_password" do
    ...
    test "sends a new reset password token", %{conn: conn, user: user} do
      ...
      assert response["message"] == "If your email is in our system, you will receive instructions to reset your password shortly."
